...
# 3 densly connected convolutions.
def BCDU_net_D3(input_size=(256, 256, 1)):
    N = input_size[0]  # N = 256
...
# 1 densly connected convolutions.
...
def SEDU_Net_D3(input_size=(256, 256, 1), learning_rate=1e-4):
    ...
    conv1 = Conv2D(64, (3, 3), activation='relu', padding='same', name='block1_conv2')(x)
    ...
    conv2 = Conv2D(128, (3, 3), activation='relu', padding='same', name='block2_conv2')(x)
    ...
    conv3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv3')(x)
    ...
    # D1
    drop4_1 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv3')(x)
    # D2
    conv4_2 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer='he_normal')(drop4_1)
    conv4_2 = Conv2D(512, 3, activation='relu', padding='same', kernel_initializer='he_normal')(conv4_2)
    conv4_2 = Dropout(0.5)(conv4_2)
    ...
    x2 = Reshape(target_shape=(1, np.int32(N / 4), np.int32(N / 4), 256))(up6)
    merge6 = concatenate([x1, x2], axis=1)
    merge6 = ConvLSTM2D(filters=256, kernel_size=(3, 3), padding='same', return_sequences=False, go_backwards=True,
                        kernel_initializer='he_normal')(merge6)
    ...
    x2 = Reshape(target_shape=(1, np.int32(N / 2), np.int32(N / 2), 128))(up7)
    merge7 = concatenate([x1, x2], axis=1)
    merge7 = ConvLSTM2D(filters=128, kernel_size=(3, 3), padding='same', return_sequences=False, go_backwards=True,
                        kernel_initializer='he_normal')(merge7)
    ...
    x2 = Reshape(target_shape=(1, N, N, 64))(up8)
    merge8 = concatenate([x1, x2], axis=1)
    merge8 = ConvLSTM2D(filters=64, kernel_size=(3, 3), padding='same', return_sequences=False, go_backwards=True,
                        kernel_initializer='he_normal')(merge8)
...
# "Bi-Directional ConvLSTM U-Net with Densely Connected Convolutions ", ICCV, 2019, download link.

# M. Asadi, R. Azad, Mahmood Fathy and Sergio Escalera
